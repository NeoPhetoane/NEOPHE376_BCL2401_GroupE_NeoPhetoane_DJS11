...
# Overview
This project is a React.js podcast listening application named Orange Juice. The name is a play on the pop culture term of news being called tea, and since I like Juice more than tea, the site was named Orange Juice. It welcomes the user with a plethora of shows upon arrical, a sedebar with different routes to favourites and search, the user can access seasons and episodes and even control the sound using the soundbar. It utilisers react state, components and routes to navigate between different features. 

# Netlify link
Netlify link : https://orangejuicepodcast.netlify.app/ 


# Setup instructions
You can view the site on netlify using the link. 
When downloaded or cloned: 

.firstly enter into the terminal "npm install" to install the dependencies
.and then "npm run dev" to run in a browser
